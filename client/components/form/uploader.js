...
export default class Uploader extends Component {
    ...
    renderFiles(){
        return this.props.files.map((file, idx)=>{
            ...
            let cls = classNames({
                'msbu-uploader__file': true,
                'msbu-uploader__file_status': error || status
            });
            ...
            return (
                <li className={cls} key={idx} style={fileStyle} onClick={handleFileClick} {...others}>
                    {
                        error || status ?
                        <div className="msbu-uploader__file-content">
    ...
    render(){
        ...
        return (
            <div className={cls}>
                <div className="msbu-uploader__hd">
                    <p className="msbu-uploader__title">{title}</p>
                    <div className="msbu-uploader__info">{files.length}/{maxCount}</div>
                </div>
                <div className="msbu-uploader__bd">
                    <ul className="msbu-uploader__files">
                        {this.renderFiles()}
                    </ul>
                    <div className="msbu-uploader__input-box">
                        <input
                        ref="uploader"//let react to reset after onchange
                        className="msbu-uploader__input"
                        type="file"
                        accept="image/*"
