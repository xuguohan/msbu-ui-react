...
class Slider extends Component {
    ...
    render(){
        ...
        let cls = classNames('msbu-slider-box', className);
        ...
        return (
            <div className={cls}>
                <div className="msbu-slider" { ...domProps }>
                    <div className="msbu-slider__inner" ref="bar">
                        <div
                            style={trackStyles}
                            className="msbu-slider__track"/>
                        <div
                            style={handlerStyles}
                            onTouchStart={this.handleTouchStart}
                            onTouchMove={this.handleTouchMove}
                            onTouchEnd={this.handleTouchEnd}
                            className="msbu-slider__handler"/>
                    </div>
                </div>
                {
                    showValue ? <div className="msbu-slider-box__value">{ this.state.value }</div> : false
                }
            </div>
        )
    }
