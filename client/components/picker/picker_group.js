...
class PickerGroup extends Component {
    ...
    render() {
        ...
        const cls = classNames('msbu-picker__group', className)
        const styles = {
        ...
        return (
            ...
            >
                <div className="msbu-picker__mask"></div>
                <div className="msbu-picker__indicator"></div>
                <div className="msbu-picker__content"
                    style={styles}
                    ref="content">
                    { items.map( (item, j) => {
                        const label = item[this.props.mapKeys.label];
                        const itemCls= classNames('msbu-picker__item', {
                            'msbu-picker__item_disabled' : item.disabled
                        })
